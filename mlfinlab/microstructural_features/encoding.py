...
def encode_tick_rule_array(tick_rule_array: list) -> str:
    ...
    """
    devadarsh.track('encode_tick_rule_array')
...
def quantile_mapping(array: list, num_letters: int = 26) -> dict:
    ...
    """
    devadarsh.track('quantile_mapping')
